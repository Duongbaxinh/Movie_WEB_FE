...
function Comment(props) {
  ...
  const { data: dataComment } = useFetch('get', `https://movie-web-backend-yui1.onrender.com/api/v1/comment/${id}`, [reloadComment])
  const [content, setContent] = useState('')
  const handleSendComment = async () => {
    usePost('https://movie-web-backend-yui1.onrender.com/api/v1/comment', {
      parentId: null,
      movieId: id,
      uSeriesd: 1,
      content: content
